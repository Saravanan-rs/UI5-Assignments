					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Paginated OData",
									"targetURL": "#odatapage-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"odatapage-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatapage",
									"url": sap.ui.require.toUrl("odatapage")
								}
							}
						}
					}
