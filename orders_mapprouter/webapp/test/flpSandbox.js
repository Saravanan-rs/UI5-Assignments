		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WK12 Orders",
									"targetURL": "#ordersmapprouter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersmapprouter-display": {
								"semanticObject": "ordersmapprouter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersmapprouter",
									"url": sap.ui.require.toUrl("ordersmapprouter")
								}
							}
						}
					}
