					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Pagination",
									"targetURL": "#pageodata-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"pageodata-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pageodata",
									"url": sap.ui.require.toUrl("pageodata")
								}
							}
						}
					}
